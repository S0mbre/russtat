...
-- Started on 2020-10-02 11:56:24
...
--
-- TOC entry 3092 (class 1262 OID 16394)
...
begin
	...
	/* add_dataset:
	IN prep_time timestamp with time zone,
	IN last_updated timestamp with time zone,
	IN next_update timestamp with time zone,
	IN ds_id text,
	IN fullname text,IN agency_id text,IN agency_name text,
	IN agency_dept text,IN codes jsonb,IN unit text,
	IN periodicity text,IN this_release text,IN data_range integer[],
	IN description text,IN classifier_id text,IN classifier_path text,
	IN prep_by text,IN prep_contacts text)
	*/
	...
	*/
	...
	if dataset_id = -1 then
		raise notice '! Unable to add dataset!';
		return;
	end if;
	...
	loop
		...
		*/
		...
		insert into obs(dataset_id, code_id, unit_id, period_id, obs_year, obs_val) 
			...
			update set obs_val = excluded.obs_val returning id into last_data_id;
...
--
-- TOC entry 232 (class 1255 OID 16554)
	...
	*/
	...
	loop
		insert into codes(name) values (codes->codename->>'name')
			on conflict on constraint codes_unique1 do
			update set name = excluded.name returning id into codes_id_;
		...
		loop
			insert into codevals(code_id, val_id, name) 
				...
				on conflict on constraint codevals_unique do nothing;
		end loop;
	end loop;
	...
	insert into datasets(prep_time, updated_time, next_update_time,
		...
		update set ds_id = excluded.ds_id returning id into ds_id_;
...
--
-- TOC entry 233 (class 1255 OID 16614)
...
CREATE TABLE public.codevals (
    id integer NOT NULL,
    code_id integer,
    val_id character varying(32) NOT NULL,
    name text NOT NULL
);
...
--
-- TOC entry 2911 (class 2606 OID 16404)
...
--
-- TOC entry 2919 (class 2606 OID 16426)
...
--
-- TOC entry 2921 (class 2606 OID 16628)
...
--
-- TOC entry 2923 (class 2606 OID 16433)
...
--
-- TOC entry 2925 (class 2606 OID 16630)
...
--
-- TOC entry 2927 (class 2606 OID 16440)
...
--
-- TOC entry 2929 (class 2606 OID 16624)
...
--
-- TOC entry 2941 (class 2606 OID 16598)
...
--
-- TOC entry 2917 (class 2606 OID 16635)
...
--
-- TOC entry 2943 (class 2606 OID 16496)
...
--
-- TOC entry 2945 (class 2606 OID 16543)
...
--
-- TOC entry 2935 (class 2606 OID 16459)
...
--
-- TOC entry 2937 (class 2606 OID 16640)
...
--
-- TOC entry 2933 (class 2606 OID 16642)
...
--
-- TOC entry 2956 (class 2620 OID 16531)
...
--
-- TOC entry 2947 (class 2606 OID 16441)
...
--
-- TOC entry 2948 (class 2606 OID 16470)
...
--
-- TOC entry 2949 (class 2606 OID 16475)
...
--
-- TOC entry 2950 (class 2606 OID 16480)
...
--
-- TOC entry 2951 (class 2606 OID 16485)
...
--
-- TOC entry 2946 (class 2606 OID 16412)
...
--
-- TOC entry 2952 (class 2606 OID 16497)
...
--
-- TOC entry 2953 (class 2606 OID 16502)
...
--
-- TOC entry 2955 (class 2606 OID 16512)
...
-- Completed on 2020-10-02 11:56:24
